...
class RecommendationPlugin extends Module
{
  public function __construct()
  {
    $this->name = 'RecommendationPlugin';
    $this->tab = 'others';
    $this->version = '1.0.0';
    $this->author = 'Muzykando Team';
    $this->need_instance = 0;
    $this->ps_versions_compliancy = array('min' => '1.6', 'max' => _PS_VERSION_);
    $this->bootstrap = true;
    parent::__construct();
    $this->displayName = $this->l('Muzykando Rekomendacje');
  ...
  public function install()
  {
    ...
    return parent::install() &&
      ...
      Configuration::updateValue('MYMODULE_NAME', 'RecommendationPlugin');
  }
